...
class x39_morphine : x39_medicSystemItemInfo
{
	scope = 2;
...
class x39_bloodbag : x39_medicSystemItemInfo
{
	scope = 2;
...
class x39_defibrillator : x39_medicSystemItemInfo
{
	scope = 2;
...
class x39_medikit : x39_medicSystemItemInfo
{
	scope = 2;
...
class x39_medikit2 : x39_medicSystemItemInfo
{
	scope = 2;
	displayName = $STR_X39_MedSys_var__Items_MediKit;
	class ItemInfo
...
class x39_medikit3 : x39_medicSystemItemInfo
{
	scope = 2;
	displayName = $STR_X39_MedSys_var__Items_MediKit;
	class ItemInfo
...
class x39_medikit4 : x39_medicSystemItemInfo
{
	scope = 2;
	displayName = $STR_X39_MedSys_var__Items_MediKit;
	class ItemInfo
...
class x39_medikit5 : x39_medicSystemItemInfo
{
	scope = 2;
	displayName = $STR_X39_MedSys_var__Items_MediKit;
	class ItemInfo
...
class x39_earplug : x39_medicSystemItemInfo
{
	scope = 2;
