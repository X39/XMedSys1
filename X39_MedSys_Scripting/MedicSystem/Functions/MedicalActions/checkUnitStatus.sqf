...
sleep X39_MedSys_var_actionTimeout_CheckUnitStatus;
...
_res = [_unit, X39_MedSys_var_Action_CheckUnit_OutputRealValues] call X39_MedSys_fnc_msg_lifeTime;			if(_res != "") then { _output = format["%1<br />-%2", _output, _res]; };if(_res != (localize "STR_X39_MedSys_var__msg_lifeTime_msg5")) then
{
