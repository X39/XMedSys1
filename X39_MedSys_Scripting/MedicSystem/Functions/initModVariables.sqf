...
private["_index"];
_index = [localize "STR_X39_MedSys_var__ReviveTopMenu",		"", "", {!X39_XLib_var_ActionDialog_IsSelf && !X39_XLib_var_ActionDialog_ExecutorInVehicle && (X39_XLib_var_ActionDialog_Executor getVariable ["X39_MedSys_var_UnitInitilized", false])}, -1] call X39_XLib_fnc_ActionDialog_registerAction;
...
[localize "STR_X39_MedSys_var__VehiclePutIntoVehicle",		"", {[0, X39_XLib_var_ActionDialog_Target, -1] call X39_MedSys_fnc_moveInVehicle},	{X39_MedSys_var_Running && (X39_XLib_var_ActionDialog_Target getVariable ["X39_MedSys_var_UnitInitilized", false]) && {!X39_XLib_var_ActionDialog_IsSelf && !X39_XLib_var_ActionDialog_ExecutorInVehicle}}, -1] call X39_XLib_fnc_ActionDialog_registerAction;
